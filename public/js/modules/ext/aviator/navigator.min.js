...
"/"!==a.charAt(0)&&(a="/"+a),a=a.replace(this.root,""),this.navigate(a))}},navigate:function(a,b){b=b||{};var c=b.namedParams,d=b.queryParams;this._actions=[];d&&(a+=this.serializeQueryParams(d));if(c)for(var e in c)c.hasOwnProperty(e)&&(a=a.replace(":"+e,encodeURIComponent(c[e])));b.silent&&(this._silent=!0);this.pushStateEnabled?(a=this._removeURIRoot(a),a=this.root+a,b.replace?history.replaceState("navigate","",a):history.pushState("navigate","",a),this.onURIChange()):b.replace?location.replace("#"+
a):location.hash=a},refresh:function(){this.dispatch()},_attachEvents:function(){this.pushStateEnabled?f(window,"popstate",this.onPopState,this):f(window,"hashchange",this.onURIChange,this);f(document,"click",this.onClick,this)},_matchesSelector:function(a){var b=document.querySelectorAll(this.linkSelector),c=!1,d;for(d=0;d<b.length&&!c;d++)c=a===b[d];return c},_invokeExits:function(a){for(var b,c;this._exits.length;){b=this._exits.pop();c=b.target;b=b.method;if(!(b in c))throw Error("Can't call exit "+
b+" on target for uri "+a.uri);c[b].call(c)}},_invokeActions:function(a,b){for(var c,d;this._actions.length;){c=this._actions.shift();d=c.target;c=c.method;if(!(c in d))throw Error("Can't call action "+c+" on target for uri "+a.uri);d[c].call(d,a,b)}},_removeURIRoot:function(a){return a.replace(new RegExp("^"+this.root),"")},serializeQueryParams:function(a){var b=[],c,d;for(d in a)a.hasOwnProperty(d)&&(c=a[d],l(c)?k(c,function(a){b.push(encodeURIComponent(d)+"[]="+encodeURIComponent(a))}):b.push(encodeURIComponent(d)+
"="+encodeURIComponent(c)));return b="?"+b.join("&")}};return e});
