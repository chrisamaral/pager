...
define(['../ext/strftime'], function (strftime) {
    ...
    ScheduleTask = React.createClass({displayName: 'ScheduleTask',
        ...
        render: function () {
            ...
            return React.DOM.div({className: classes, onClick: this.showDropDown, 
    ...
    var SInfoContainer = React.createClass({displayName: 'SInfoContainer',
        render: function () {
            return React.DOM.div({id: this.props.elemID, className: "f-dropdown medium content", 'data-dropdown-content': true});
        }
    });
    ...
    var ScheduleRowMenu = React.createClass({displayName: 'ScheduleRowMenu',
        render: function () {
            return React.DOM.ul({id: this.props.elemID, className: "f-dropdown", 'data-dropdown-content': true}, 
