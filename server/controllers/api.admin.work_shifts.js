...
function saveShift (req, res) {
    ...
    app.mongo.collection('work_shift', function (err, shiftCollection) {
...
app.express.post('/:org/api/admin/work_shift', app.authorized.can('enter app'), saveShift);
app.express.post('/:org/api/admin/work_shift/:id', app.authorized.can('enter app'), saveShift);
app.express.delete('/:org/api/admin/work_shift/:id', app.authorized.can('enter app'), function (req, res) {
...
app.express.get('/:org/api/admin/work_shifts', app.authorized.can('enter app'), function (req, res) {
    app.mongo.collection('work_shift', function (err, shiftCollection) {
